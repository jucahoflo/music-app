...
const songsData: Record<string, any[]> = {
  ...
  bolero: [],
  madres: [
    { id: '1779571546', title: 'VERSOS_A_MI_MADRE', artist: 'charlie zaa', duration: '4:35', mp3Url: '/mp3/VERSOS_A_MI_MADRE.mp3', pdfUrl: '/pdf/VERSOS_A_MI_MADRE.pdf' },
    { id: '1779571414', title: 'SE_PARECE_A_MI_MAMA', artist: 'palito ortega', duration: '2:48', mp3Url: '/mp3/SE_PARECE_A_MI_MAMA.mp3', pdfUrl: '/pdf/SE_PARECE_A_MI_MAMA.pdf' },
